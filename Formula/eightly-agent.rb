class EightlyAgent < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/imogenlabs/eightly-agent/releases/download/v1.0.0-beta1/eightly-agent-darwin-arm64"
      sha256 "b7f0fc04143e199694127bf8c16a0fd063f170953039e2008d22599f82abc936"
    end
    on_intel do
      url "https://github.com/imogenlabs/eightly-agent/releases/download/v1.0.0-beta1/eightly-agent-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/imogenlabs/eightly-agent/releases/download/v1.0.0-beta1/eightly-agent-linux-arm64"
      sha256 "075441de667d1c1026a59b0f91dca521b92f76b8de3a83d3feb718f692dba691"
    end
    on_intel do
      url "https://github.com/imogenlabs/eightly-agent/releases/download/v1.0.0-beta1/eightly-agent-linux-amd64"
